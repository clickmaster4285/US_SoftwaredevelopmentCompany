...
export default function SpaceJourney() {
  ...
  const chapters = useMemo(() => buildChapters({ c1, c2, c3, c4 }), []);

  const starsNear = useMemo(
    () =>
      Array.from({ length: STAR_COUNT.near }, () => ({
        x: Math.random() * 100,
        y: Math.random() * 100,
        s: 1 + Math.random() * 2.5,
      })),
  ...
  const starsMid = useMemo(
    () =>
      Array.from({ length: STAR_COUNT.mid }, () => ({
        x: Math.random() * 100,
        y: Math.random() * 100,
  ...
  const starsFar = useMemo(
    () =>
      Array.from({ length: STAR_COUNT.far }, () => ({
        x: Math.random() * 100,
        y: Math.random() * 100,
        s: 0.4 + Math.random() * 1,
      })),
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set(skyRef.current, {
        background:
          "linear-gradient(180deg, oklch(0.30 0.03 250) 0%, oklch(0.18 0.02 250) 100%)",
        opacity: 0,
      });
      gsap.set(
        [starsFarRef.current, starsMidRef.current, starsNearRef.current],
        { opacity: 0 },
      );
      ...
      tl.to(introCopyRef.current, { opacity: 0, x: 120, duration: 0.5 }, 0)
        ...
        .to(
          tabletRef.current,
          { scale: 6, rotate: -2, duration: 1, ease: "power2.in" },
          0,
        )
      ...
      tl.to(
        ...
        {
          background:
            "linear-gradient(180deg, oklch(0.18 0.02 250) 0%, oklch(0.08 0.01 250) 100%)",
          duration: 1,
        },
        1,
      )
        .to(
          groundRef.current,
          { y: 700, opacity: 0, duration: 1, ease: "power2.in" },
          1,
        )
        .to(
      ...
      tl.to(worldRef.current, { rotateZ: 2, duration: 1 }, 2)
        ...
        .to(
          ringsRef.current,
          { scale: 4, opacity: 0.25, duration: 1, ease: "power1.in" },
          2,
        )
        .to(
          [starsNearRef.current, starsMidRef.current],
          { scale: 1.6, y: -100, duration: 1 },
          2,
        )
      ...
      tl.to(worldRef.current, { rotateZ: -1.5, duration: 1 }, 3)
        .to(
          ...
          {
            background:
              "linear-gradient(180deg, oklch(0.14 0.015 240) 0%, oklch(0.06 0.01 250) 100%)",
            duration: 1,
          },
          3,
        )
        .to(
          planet1Ref.current,
          { left: "-25%", top: "22%", scale: 0.6, opacity: 0, duration: 1 },
          3,
        )
        .to(
          planet2Ref.current,
        ...
        .to(
          astroWrapRef.current,
          { left: "30%", top: "58%", scale: 0.9, rotate: 14, duration: 1 },
          3,
        )
        .to(
          [starsNearRef.current, starsMidRef.current, starsFarRef.current],
          { y: -240, duration: 1 },
          3,
        )
      ...
      tl.to(worldRef.current, { rotateZ: 0, duration: 1 }, 4)
        .to(
          planet2Ref.current,
          { left: "140%", top: "70%", scale: 0.5, opacity: 0, duration: 1 },
          4,
        )
        .to(
          skyRef.current,
          {
            background:
              "radial-gradient(circle at 50% 50%, oklch(0.20 0.02 250) 0%, oklch(0.05 0.01 250) 75%)",
            duration: 1,
          },
          4,
        )
        ...
        .to(
          [starsNearRef.current, starsMidRef.current, starsFarRef.current],
          { scale: 2.6, y: -460, opacity: 0.5, duration: 1 },
          4,
        )
  ...
  return (
    <section
      ...
      style={{ height: "850vh" }}
      aria-label="Cinematic journey to Let's Work Together"
    >
      <div
        ref={stageRef}
      ...
      >
        ...
        <div ref={worldRef} className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, oklch(0.32 0.04 80) 0%, oklch(0.16 0.03 60) 100%)",
          ...
          <img
            ...
            style={{
              filter: "drop-shadow(0 0 60px oklch(0.40 0.03 250 / 0.55))",
            }}
          />
          <img
            ref={planet2Ref}
            ...
            style={{
              filter: "drop-shadow(0 0 70px oklch(0.45 0.02 240 / 0.5))",
            }}
          />
          ...
          >
            <img
              ...
              style={{
                filter:
                  "drop-shadow(0 30px 80px rgba(0,0,0,0.6)) drop-shadow(0 0 30px oklch(0.55 0.02 240 / 0.35))",
              }}
            />
          </div>
        </div>
        ...
        <div ref={introRef} className="absolute inset-0 z-20">
          ...
          <div
            ...
            style={{
              borderColor: "oklch(0.88 0.12 190)",
          ...
          <div className="relative h-full w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-10 px-6 md:px-16 max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-center">
              <div
                ...
                style={{
                  boxShadow:
                    "0 40px 120px -20px rgba(0,0,0,0.35), 0 0 0 1px rgba(0,0,0,0.04)",
                }}
              >
                <div className="absolute inset-3 rounded-[26px] overflow-hidden bg-black">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(120% 80% at 50% 100%, oklch(0.30 0.12 240 / 0.55), transparent 60%)",
                    }}
                  />
                </div>
                {/* Camera dot */}
            ...
            <div ref={introCopyRef} className="text-neutral-900 max-w-md">
              ...
              <p className="mt-10 text-[10px] uppercase tracking-[0.5em] opacity-60">
                Scroll to enter
              </p>
            </div>
          </div>
        ...
        <div className="absolute inset-x-0 top-[14%] flex justify-center px-6 pointer-events-none z-10">
          {chapters.map((c, i) => (
            <div
              key={i}
              ref={c.ref}
              className={`text-center max-w-2xl ${i === 0 ? "" : "absolute"}`}
            >
              <p className="text-[10px] uppercase tracking-[0.5em] opacity-60 mb-3">
                {c.kicker}
              </p>
              <h2 className="text-[clamp(2rem,5.4vw,4.5rem)] font-semibold tracking-tight leading-[1.02]">
                {c.title}
              </h2>
              <p className="mt-4 text-sm md:text-base opacity-70 max-w-md mx-auto">
                {c.sub}
              </p>
            </div>
          ))}
        ...
        <div
          ref={ctaRef}
          className="absolute inset-x-0 bottom-[12%] flex flex-col items-center px-6 text-center z-10"
        >
          <p className="text-[10px] uppercase tracking-[0.5em] opacity-60 mb-4">
            The mission
          </p>
