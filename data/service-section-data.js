...
export const SERVICE_SECTION_DATA = {
  ...
  "web-development": {
    ...
    features: [
      ...
      feature(
        "SEO Optimized",
        "Built-in performance and search best practices",
        "Search",
      ),
      feature(
        "High Conversion",
        "UX focused on leads and revenue",
        "TrendingUp",
      ),
    ],
    stats: [
    ...
    pricing: [
      tier(
        "Business Website",
        "$3,500+",
        "SMBs needing a professional web presence",
        "3–6 weeks",
      ...
      tier(
        "Web Application",
        "$15,000+",
        "Portals, dashboards, and custom apps",
        "2–4 months",
        [
          "Custom UX/UI",
          "Auth & roles",
      ...
      tier(
        ...
        "$45,000+",
        "High-traffic, multi-tenant systems",
        "4–12 months",
        [
    ...
    faqs: [
      faq(
        ...
        "Marketing sites start from $3,500. Custom web apps range $15,000–$45,000+. Enterprise platforms are scoped individually.",
      ),
      faq(
        "Which stack do you use for web projects?",
        "We primarily use Next.js, React, Node.js, and headless CMS options (Sanity, Contentful) with cloud hosting on Vercel, AWS, or Azure.",
      ),
      faq(
        "Will my site be SEO-friendly?",
        "Yes. We implement semantic HTML, Core Web Vitals optimization, structured data, and technical SEO foundations from day one.",
      ),
      faq(
        "Can you redesign an existing website?",
        "Absolutely. We audit performance, UX, and code quality, then migrate or rebuild with minimal downtime.",
      ),
    ],
  },
  ...
  "mobile-development": {
    ...
    features: [
      feature(
        "Native Performance",
        "Swift and Kotlin expertise for iOS and Android",
        "Smartphone",
      ),
      feature(
        "Cross-Platform",
        "React Native and Flutter for faster delivery",
        "Layers3",
      ),
      feature(
        "App Store Ready",
        "Submission, analytics, and release management",
        "Rocket",
      ),
    ],
    stats: [
    ...
    pricing: [
      tier(
        "MVP App",
        "$12,000+",
        "Founders validating a mobile idea",
        "8–14 weeks",
      ...
      tier(
        "Cross-Platform App",
        "$28,000+",
        "Teams needing iOS + Android together",
        "3–5 months",
        [
      ...
      tier(
        "Enterprise Mobile",
        "$55,000+",
        "Regulated or high-scale products",
        "5–12 months",
        [
          "Native builds",
          "MDM & security",
    ...
    faqs: [
      ...
      faq(
        ...
        "Yes. We manage certificates, store listings, review cycles, and post-launch updates.",
      ),
      faq(
        "How long does mobile app development take?",
        "MVPs ship in 8–14 weeks. Full products typically take 3–6 months depending on integrations and compliance.",
      ),
      faq(
        "Can you maintain our app after launch?",
        "We offer retainers for bug fixes, OS updates, feature releases, and performance monitoring.",
      ),
    ],
  },
  ...
  "design-ui-ux": {
    ...
    features: [
      feature(
        "User Research",
        "Decisions backed by real user insights",
        "Search",
      ),
      feature(
        "Design Systems",
        "Scalable components for product teams",
        "LayoutDashboard",
      ),
      feature(
        "Conversion UX",
        "Interfaces that drive measurable outcomes",
        "TrendingUp",
      ),
    ],
    stats: [
    ...
    pricing: [
      tier(
        "UX Audit",
        "$2,500+",
        "Teams improving an existing product",
        "2–3 weeks",
        [
          "Heuristic review",
          "Usability findings",
      ...
      tier(
        "Design System",
        "$18,000+",
        "Scaling products and design ops",
        "6–12 weeks",
        [
          "Component library",
          "Figma tokens",
    ...
    faqs: [
      faq(
        ...
        "Discovery, user flows, wireframes, high-fidelity UI, prototypes, and developer-ready design specs.",
      ),
      faq(
        "Which tools do your designers use?",
        "Figma is our primary tool, with optional integration into Jira, Linear, and Storybook for handoff.",
      ),
      faq(
        "Can you work with our existing brand guidelines?",
        "Yes. We extend brand systems into product UI while improving usability and consistency.",
      ),
      faq(
        "How do you measure design success?",
        "We track usability metrics, task completion, conversion, and qualitative feedback from user testing.",
      ),
    ],
  },
  ...
  "artificial-intelligence-ai": {
    ...
    features: [
      feature(
        "Production AI",
        "Ship LLM apps beyond proof-of-concept",
        "Brain",
      ),
      feature(
        "Secure by Design",
        "Governance, guardrails, and data privacy",
        "ShieldCheck",
      ),
      feature(
        "Measurable ROI",
        "Automation tied to business KPIs",
        "BarChart3",
      ),
    ],
    stats: [
    ...
    pricing: [
      tier(
        "AI PoC",
        "$8,000+",
        "Teams exploring a focused AI use case",
        "4–8 weeks",
        [
          "Use-case workshop",
          "Prototype",
    ...
    faqs: [
      faq(
        ...
        "Retrieval-Augmented Generation grounds LLM answers in your private data. We build RAG pipelines with vector stores, chunking, and evaluation.",
      ),
      faq(
        "Which AI models do you work with?",
        "OpenAI, Anthropic, Google Gemini, and open-source models via Azure, AWS Bedrock, or self-hosted deployments.",
      ),
      faq(
        "How do you keep AI outputs accurate and safe?",
        "We use guardrails, prompt testing, human-in-the-loop review, and monitoring for hallucinations and policy violations.",
      ),
      faq(
        "Can AI integrate with our existing software?",
        "Yes. We connect CRMs, ERPs, support tools, and internal APIs via secure integration layers.",
      ),
    ],
  },
  ...
  "machine-learning-ml": {
    ...
    features: [
      ...
      feature(
        "Explainable AI",
        "Transparent models your team can trust",
        "Eye",
      ),
    ],
    stats: [
    ...
    pricing: [
      ...
      tier(
        "Custom ML Solution",
        "$22,000+",
        "Production models in your stack",
        "2–5 months",
        [
          "Feature engineering",
          "Model training",
    ...
    faqs: [
      faq(
        ...
        "Historical labeled data is ideal. We can also help collect, clean, and label data when starting from scratch.",
      ),
      faq(
        "How long until we see results from ML?",
        "Proof-of-value models often land in 4–8 weeks. Production deployments typically take 2–5 months.",
      ),
      faq(
        "Do you support real-time predictions?",
        "Yes. We deploy models via APIs, batch jobs, or streaming pipelines depending on latency requirements.",
      ),
      faq(
        "How do you prevent model drift?",
        "We implement monitoring, retraining schedules, and performance alerts when accuracy drops in production.",
      ),
    ],
  },
  ...
  "nlp-computer-vision": {
    ...
    features: [
      feature(
        "NLP at Scale",
        "Search, classification, and extraction",
        "MessageCircle",
      ),
      feature("Computer Vision", "Detection, OCR, and video analytics", "Eye"),
      feature(
        "Multimodal AI",
        "Combine text, image, and audio signals",
        "Brain",
      ),
    ],
    stats: [
    ...
    pricing: [
      ...
      tier(
        ...
        "$55,000+",
        "Multi-site, high-volume processing",
        "6–14 months",
    ...
    faqs: [
      faq(
        "What NLP tasks do you support?",
        "Entity extraction, sentiment, summarization, semantic search, chatbots, and document classification.",
      ),
      faq(
        "Can you process scanned PDFs and images?",
        "Yes. We combine OCR with NLP pipelines for invoices, contracts, forms, and medical records.",
      ),
      faq(
        "Do you build real-time video analytics?",
        "We deliver object detection, tracking, and alerting for security, retail, and industrial use cases.",
      ),
      faq(
        "How do you handle sensitive visual or text data?",
        "Data is encrypted in transit and at rest, with optional on-prem or VPC-only deployment.",
      ),
    ],
  },
  ...
  "data-services": {
    ...
    faqs: [
      faq(
        ...
        "Snowflake, BigQuery, Redshift, Databricks, PostgreSQL, and modern stack tools like dbt, Airflow, and Fivetran.",
      ),
      faq(
        "Can you migrate our legacy reports to modern BI?",
        "Yes. We rebuild dashboards in Power BI, Looker, or Metabase with governed semantic layers.",
      ),
      faq(
        "How do you ensure data quality?",
        "We implement validation rules, anomaly detection, lineage tracking, and documented ownership per dataset.",
      ),
      faq(
        "Do you offer ongoing data engineering support?",
        "We provide retainers for pipeline maintenance, new sources, and performance optimization.",
      ),
    ],
  },
  ...
  cybersecurity: {
    ...
    faqs: [
      faq(
        ...
        "Reconnaissance, vulnerability exploitation, impact analysis, and a prioritized remediation report.",
      ),
      faq(
        "How often should we run security audits?",
        "We recommend quarterly scans and annual penetration tests, plus after major releases.",
      ),
      faq(
        "Can you help us achieve SOC2 compliance?",
        "Yes. We map controls, implement technical safeguards, and prepare evidence for auditors.",
      ),
      faq(
        "Do you offer incident response?",
        "We provide retainer-based IR support including containment, forensics, and recovery planning.",
      ),
    ],
  },
  ...
  "testing-and-qa": {
    ...
    features: [
      ...
      feature(
        "Performance Testing",
        "Load, stress, and scalability validation",
        "Zap",
      ),
    ...
    faqs: [
      faq(
        ...
        "Yes. We combine exploratory manual testing with Selenium, Cypress, Playwright, and API automation.",
      ),
      faq(
        "Can you join our existing agile sprints?",
        "We embed QA engineers in your sprints with test cases, automation, and release gates every 2 weeks.",
      ),
      faq(
        "What types of testing do you cover?",
        "Functional, regression, API, mobile, performance, security smoke, and UAT support.",
      ),
      faq(
        "How do you report bugs and quality metrics?",
        "Via Jira, Linear, or your tool of choice with severity, reproduction steps, and sprint quality dashboards.",
      ),
    ],
  },
  ...
  "blockchain-and-web3": {
    ...
    features: [
      ...
      feature(
        "Web3 Integration",
        "Connect existing products to chain",
        "Link2",
      ),
    ],
    stats: [
    ...
    pricing: [
      ...
      tier(
        "Enterprise Web3",
        "$70,000+",
        "Private chain or hybrid solutions",
        "6–12 months",
        [
    ...
    faqs: [
      faq(
        ...
        "Ethereum, Polygon, Solana, BNB Chain, and private EVM networks depending on your use case.",
      ),
      faq(
        "Do you audit smart contracts?",
        "We follow secure development practices and coordinate third-party audits before mainnet deployment.",
      ),
      faq(
      ...
      faq(
        ...
        "We run discovery workshops to assess whether blockchain adds real value vs. traditional architecture.",
      ),
    ],
  },
  ...
  "support-and-outsourcing": {
    ...
    features: [
      ...
      feature(
        "Flexible Scale",
        "Augment or fully outsource delivery",
        "UserCheck",
      ),
    ],
    stats: [
    ...
    faqs: [
      faq(
        ...
        "Bug fixes, dependency updates, monitoring, backups, and minor enhancements within agreed hours.",
      ),
      faq(
        "How quickly can you onboard dedicated developers?",
        "Most roles start within 1–2 weeks after skills alignment and contract signing.",
      ),
      faq(
        "Do your teams work in our timezone?",
        "We offer overlap with UK, EU, and US hours and assign PMs for transparent communication.",
      ),
      faq(
        "Can we scale the team up or down?",
        "Yes. Contracts support monthly adjustments with agreed notice periods.",
      ),
    ],
  },
};
...
export function enrichServiceData(slug, service) {
  ...
  const stats =
    service.stats?.length >= MIN_STATS
      ? service.stats
      : (extra.stats ?? service.stats);
