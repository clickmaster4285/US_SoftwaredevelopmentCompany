...
5. Reusability - Avoided recreating components; leveraged existing ones
   like big companies do
6. Reusability - Avoided recreating components; leveraged existing ones
7. Professional look - Plain background image with light theme text for clean, corporate feel
