                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {active.items.map((item) => (
                        ...
                        >
                          <DynamicIcon
                            name={item.icon}
                            className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-secondary text-sm font-bold text-primary transition-colors group-hover/sub:bg-accent group-hover/sub:scale-105"
                          />
                  ...
                  <div className="flex h-full items-center justify-center py-20 text-center">
                    <div className="max-w-sm">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Select a service category to discover how we can help
                        your business grow with tailored solutions.
                      </p>
                    </div>
                  </div>
                )}
